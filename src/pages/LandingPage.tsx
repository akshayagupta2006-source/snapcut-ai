    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative pt-32 pb-20 px-6 overflow-hidden">
        ...
        <div className="relative z-10 max-w-6xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-primary/10 border border-primary/30 rounded-full text-sm text-foreground mb-6">
              <Sparkles className="w-3.5 h-3.5 text-primary" />
              AI-Powered Background Removal
            </div>
            <h1 className="text-4xl md:text-6xl font-display font-bold text-foreground leading-tight mb-6">
              Remove Image <span className="text-gradient">Backgrounds</span> in
              One Click
            </h1>
            ...
            <div className="flex flex-wrap gap-4">
              <Link
                to="/upload"
                className="inline-flex items-center gap-2 px-7 py-3.5 bg-gradient-primary text-primary-foreground rounded-xl font-semibold text-base hover:opacity-90 transition-opacity shadow-lg"
              ...
              <a
                href="#demo"
                className="inline-flex items-center gap-2 px-7 py-3.5 border border-border rounded-xl text-foreground font-medium hover:bg-secondary transition-colors"
              >
                See Demo
            ...
            <div className="flex items-center gap-6 mt-8 text-sm text-muted-foreground">
              <span className="flex items-center gap-1.5">
                <Check className="w-4 h-4 text-primary" /> No signup required
              </span>
              <span className="flex items-center gap-1.5">
                <Check className="w-4 h-4 text-primary" /> Free 3 images/day
              </span>
            </div>
          </motion.div>
            ...
            {[
              ...
              >
                <div className="bg-card border border-border rounded-2xl p-8 hover:border-primary/40 transition-colors">
                  <div className="text-6xl font-display font-bold text-muted/30 absolute top-4 right-6">
                    {item.step}
                  </div>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {features.map((f, i) => (
              ...
              >
                <div className="w-12 h-12 bg-primary/10 rounded-xl flex items-center justify-center mb-4 group-hover:bg-gradient-primary transition-colors">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {plans.map((plan, i) => (
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ delay: i * 0.1 }}
                className={`relative bg-card border rounded-2xl p-7 ${plan.popular ? "border-primary card-glow" : "border-border"}`}
              >
                {plan.popular && (
                ...
                <div className="flex items-center gap-3 mb-4">
                  <div
                    className={`w-10 h-10 rounded-xl flex items-center justify-center ${plan.popular ? "bg-gradient-primary" : "bg-secondary"}`}
                  >
                    <plan.icon
                      className={`w-5 h-5 ${plan.popular ? "text-primary-foreground" : "text-foreground"}`}
                    />
                  </div>
                ...
                <button
                  ...
                  className={`block w-full py-2.5 rounded-xl font-medium text-sm text-center transition-opacity hover:opacity-90 ${
                    plan.popular
      ...
      <section className="py-24 px-6">
        <motion.div className="max-w-3xl mx-auto text-center" {...fadeUp}>
          ...
          <Link
            to="/upload"
            className="inline-flex items-center gap-2 px-8 py-4 bg-gradient-primary text-primary-foreground rounded-xl font-semibold text-lg hover:opacity-90 transition-opacity"
            style={{ boxShadow: "var(--shadow-glow)" }}
          >
            <Upload className="w-5 h-5" />
